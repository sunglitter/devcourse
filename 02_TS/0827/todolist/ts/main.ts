...
const seasons = document.querySelector(".left") as HTMLElement;
switch (month) {
  case 3:
  case 4:
  case 5:
...
const toggleBtn = document.querySelector(".menuImage") as HTMLElement;
...
document.getElementById("category")!.addEventListener("change", function () {
  const select = this as HTMLElement;
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const categorySelect = document.getElementById("category") as HTMLElement;
  const addedtdlWrap = document.querySelector(".addedtdl-wrap") as HTMLElement;
  ...
  addButton!.addEventListener("click", function () {
    const itemInput = document.querySelector(".item") as HTMLElement;
  ...
  `;
    ...
    newItem
      ...
      .addEventListener("click", function () {
        const addedtdl = newItem.querySelector(".addedtdl") as HTMLElement;
        const addedctg = newItem.querySelector(".addedctg") as HTMLElement;
        const addeddate = newItem.querySelector(".addeddate") as HTMLElement;
        const subject = newItem.querySelector(".subject") as HTMLElement;
